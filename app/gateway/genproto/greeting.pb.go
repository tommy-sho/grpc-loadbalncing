...
var fileDescriptor_6acac03ccd168a87 = []byte{
	...
	0x2d, 0xc9, 0xcc, 0x4b, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x80, 0xf1, 0x95, 0x54,
	0xb9, 0xf8, 0xdd, 0xa1, 0xec, 0xa0, 0xd4, 0xc2, 0xd2, 0xd4, 0xe2, 0x12, 0x21, 0x21, 0x2e, 0x96,
	...
	0x38, 0x31, 0x1d, 0xa6, 0x14, 0xc6, 0x35, 0x0a, 0xe5, 0xe2, 0x83, 0xa9, 0x0e, 0x4e, 0x2d, 0x2a,
	0x4b, 0x2d, 0x12, 0x72, 0xe6, 0xe2, 0x80, 0x89, 0x08, 0x49, 0xea, 0xc1, 0x5d, 0x83, 0x66, 0xb5,
	0x94, 0x14, 0x36, 0x29, 0x88, 0x75, 0x4a, 0x0c, 0x49, 0x6c, 0x60, 0xc7, 0x1b, 0x03, 0x02, 0x00,
	0x00, 0xff, 0xff, 0xa4, 0xb3, 0xcf, 0x3f, 0xce, 0x00, 0x00, 0x00,
}
...
func (c *greetingServerClient) Greeting(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/greeting.GreetingServer/Greeting", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GreetingServer_Greeting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greeting.GreetingServer/Greeting",
	}
...
var _GreetingServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "greeting.GreetingServer",
